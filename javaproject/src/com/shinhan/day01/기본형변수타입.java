...
public class 기본형변수타입 {
	...
	public static void f9(String[] args) {
		//문자열을 저장하고자한다. (String class를 사용한다.)
		//1.객체참조변수선언
		...
		System.out.println(str1==str2);//==는 주소비교이다. 주소같다
		System.out.println(str3==str4);//==는 주소비교이다. 주소다르다
	...
	public static void f1(String[] args) {
		...
		a= 127;
		a++;a++;a++;
		//지역변수(메서드내의 변수)는 반드시 초기화하고 사용한다. 
