...
public class ArrayTest {
	...
	private static void call8() {
		...
		for(int i=0;i<arr.length;i++) {
			...
			System.out.println(arr[i].equals(arr2[i])?"---값이같다":"---값이다르다");
		}
	...
	private static void call() {
		...
		//같은 타입의 값을 여러개 저장하고자한다(하나의 이름으로 연속공간을 index로 참조한다.)
		//index는 0부터 시작한다. 
		//1.배열선언
		int[] arr1;
		double arr2[];
		...
		char[] arr4;
		String[] arr5;
		//2.배열생성...반드시 개수를 알아야한다.자동으로 초기화된다.
