...
<%-- 값 저장 - 자바로 쓸 때 (서블릿 내용임. jsp에서 하면 안됌) --%>
...
<img src="${cpath}/static/images/tangerines.jpg" width="100" height="100">	
<img src="${cpath}/static/images/cat.jpg" width="100" height="100">	
...
<%-- 1부터 5까지 반복하고 1씩 증가시킴. --%>
<c:forEach begin="1" end="5" step="1" var="su">
	<p>현재값: ${su}.......
		<c:if test="${su%2 == 0}">
			<span>짝수</span>
		</c:if>
